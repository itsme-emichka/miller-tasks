...
## Checkpoint 14b2 compact Today beta distribution

- Version `0.1.2` publishes checkpoint 14a1 through the existing BRAT
  repository entry for Mac, iPhone, and narrow-window physical QA.
- The prerelease contains exactly the production `main.js`, `manifest.json`,
  and `styles.css` assets built after the complete verification command passes.
- The release changes compact presentation only. Desktop Today, task data,
  replica synchronization, and the device-local Undo/Redo boundary remain
  unchanged.

## Checkpoint 14b3 mobile gesture-fix beta distribution

- Version `0.1.3` publishes checkpoint 14a2 through the existing BRAT
  repository entry for physical iPhone retesting.
- The prerelease contains exactly the production `main.js`, `manifest.json`,
  and `styles.css` assets built after all 123 tests, lint, TypeScript, and the
  production build pass.
...
## Checkpoint 14b4 compact UI follow-up beta distribution

- Version `0.1.4` publishes checkpoints 14a3 through 14a6 through the existing
  BRAT repository entry for Mac, iPhone, and narrow-window retesting.
- The prerelease contains exactly the production `main.js`, `manifest.json`,
  and `styles.css` assets built after all 125 tests, lint, TypeScript, and the
  production build pass.
